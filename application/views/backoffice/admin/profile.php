              ...
              <!-- general form elements -->
                ...
                <div class="box box-warning">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url(); ?>resource/backoffice/assets/dist/img/avatar.png" alt="User profile picture">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="<?= ($active == "details")? "active" : "" ?> tab-pane" id="details">
                            <form action="<?php echo site_url() ?>backoffice/profileUpdate" method="post" id="editProfile" role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">                                
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" value="<?php echo $adminId; ?>" name="adminId" id="adminId" />    
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                        ...
                        <div class="<?= ($active == "changepass")? "active" : "" ?> tab-pane" id="changepass">
                            <form role="form" action="<?php echo site_url() ?>backoffice/changePassword" method="post">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
...
<script src="<?php echo base_url(); ?>resource/backoffice/assets/js/editUser.js" type="text/javascript"></script>