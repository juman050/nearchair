            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo site_url() ?>backoffice/editUser" method="post" id="editUser" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
...
<script src="<?php echo site_url(); ?>resource/backoffice/assets/js/editUser.js" type="text/javascript"></script>