...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Nearchair : Forgot Password</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b>Nearchair</b><br>Admin System</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="<?php echo site_url(); ?>backoffice/resetPasswordUser" method="post">
        ...
        <a href="<?php echo site_url() ?>backoffice">Login</a><br>
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
