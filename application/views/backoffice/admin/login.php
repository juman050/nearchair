...
<html>
  <head>
    <meta charset="UTF-8">
    <title>NearChair | Admin System Log in</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box" style="background: #fff;">
      ...
      <?php 
        $logo = system_info()->nearchair_web_logo;
      ?>
        <a href="#">
            <img src="<?php echo site_url("drives/logo/web/").$logo; ?>"/>
        </a>
      </div><!-- /.login-logo -->
      <div class="login-box-body" style="padding-top: 12px;">
       ...
       <!-- <a href="<?php echo site_url() ?>backoffice/forgotPassword">Forgot Password</a><br>-->
