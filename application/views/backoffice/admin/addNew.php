            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo site_url() ?>NearchairDashboard/addNewUser" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
...
<script src="<?php echo base_url(); ?>resource/backoffice/assets/js/addUser.js" type="text/javascript"></script>