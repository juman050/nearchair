        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="ordersTable" style="background: #ffffff;border-radius: 19px;padding: 15px 10px;height:auto;">
                    ...
                    <p style="color: #202023;font-size: 20px;font-family: font92726;"><?php echo $orderInfo[0]->customer_name; ?></p>
                    <p style="color: #717171;font-size: 16px;font-family: font92726;"><?php echo $orderInfo[0]->customer_contact; ?></p>
                    <p style="color: #717171;font-size: 16px;font-family: font92726;"><?php echo ($orderInfo[0]->customer_address!="") ? $orderInfo[0]->customer_address : ''; ?></p>
                    
                    <p style="color: #717171;font-size: 16px;"><?php echo date( 'M d, Y h:i a',strtotime($orderInfo[0]->order_total)); ?></p>
                    <p style="color: #202023;font-size: 18px;font-family: font92726;">Order ID : <?php echo $orderInfo[0]->orderId; ?></p>
                            ...
                            <?php 
                                ...
                                if($orderServices){
                                    foreach($orderServices as $services){
                                        $totalServicePrice = $services->servicePrice + $totalServicePrice;
                            ?>
                    
                            <tr>
                                <td class="tblTD"><span class="common_data_left"><?php echo $services->serviceName; ?></span></td>
                                <td class="tblTD"><span class="common_data_right"><?php echo $services->servicePrice; ?> TK</span></td>
                            </tr>
                    ...
                    <div class="ordersTable" style="background: #ffffff;min-height: 60px;width: 100%;">
                            ...
                            <form action="<?php echo base_url(); ?>backoffice/homeservice/updateOrder" method="POST" style="width: 50%;float: left;">
                                <input type="hidden" name="order_id" value="<?php echo $orderInfo[0]->orderId; ?>" />
