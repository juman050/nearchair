...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
          <form action="<?php echo base_url() ?>orderListing" method="POST" id="searchList">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><?php echo $record->business_name ?> <p><b>( <i class="fa fa-mobile"></i> <?php echo $record->mobile_number ?>)</b></p></td>
                        <td><?php echo $record->fullname ?> <p><b>(<i class="fa fa-mobile"></i> <?php echo $record->mobile ?>)</b></p></td>
                        <td>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-success moveOrder" href="#" data-order_id="<?php echo $record->order_id; ?>" data-order_status="1" title="move to success"><i class="fa fa-reply"></i> Accepted</a>
                            <?php }else{?>
                            <a class="btn btn-sm btn-warning moveOrder" href="#" data-order_id="<?php echo $record->order_id; ?>" data-order_status="0" title="move to pending"><i class="fa fa-reply"></i> Pending</a>
                            <?php }?>
                            | <a class="btn btn-sm btn-info" href="<?php echo base_url().'backoffice/order/view/'.$record->order_id; ?>" title="Edit">view</a>
                            <a class="btn btn-sm btn-danger deleteOrder" href="#" data-order_id="<?php echo $record->order_id; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
